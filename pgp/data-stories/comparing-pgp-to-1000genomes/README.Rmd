...
setwd("/YOUR/PATH/TO/bigquery-examples/pgp/data-stories/comparing-pgp-to-1000genomes")
...
```{r init, echo=FALSE, message=FALSE, warning=TRUE, comment=NA}
require(bigrquery)
require(ggplot2)
require(scales)
require(dplyr)
...
```{r echo=FALSE, message=FALSE, warning=TRUE, comment=NA, cache=FALSE}
...
```{r echo=FALSE, message=FALSE, warning=TRUE, comment=NA, results="asis"}
print(xtable(head(result), digits=6), type="html", include.rownames=F)
```

```{r variant counts, echo=FALSE, message=FALSE, warning=TRUE, comment=NA, fig.align="center", fig.width=12, fig.height=8}
...
```{r variant type counts, echo=FALSE, message=FALSE, warning=TRUE, comment=NA, fig.align="center", fig.width=12, fig.height=8}
result$reference_name <- factor(result$reference_name, levels=c(as.character(seq(1,22)), "X", "Y", "MT"))
...
```{r pgp variant type counts, echo=FALSE, message=FALSE, warning=TRUE, comment=NA, fig.align="center", fig.width=12, fig.height=8}
...
```{r genotype heatmap, echo=FALSE, message=FALSE, warning=TRUE, comment=NA, fig.align="center", fig.width=12, fig.height=8}
ggplot(result) +
