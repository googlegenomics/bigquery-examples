...
result <- DisplayAndDispatchQuery("../../sql/issues-with-the-variant-centric-approach/klotho.sql")
```
...
```{r eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
result <- DisplayAndDispatchQuery("../../sql/allelic-frequency.sql")
```

```{r eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, comment=NA, results="asis"}
print(xtable(result), type="html", include.rownames=F)
```


```{r eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
result <- DisplayAndDispatchQuery("../../sql/allelic-frequency-comparison.sql")
```
