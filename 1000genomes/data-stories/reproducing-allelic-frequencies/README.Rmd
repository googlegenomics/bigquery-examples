...
sql <- readChar('../../sql/reproducing-allelic-frequencies/reproducing-allelic-frequency.sql',
               nchars=1e6)
cat(sql)
...
sql <- readChar('../../sql/reproducing-allelic-frequencies/reproducing-allelic-frequency-by-ethnicity.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
...
sql = readChar('../../sql/minimum-allelic-frequency-by-ethnicity-no-sex-chromosomes.sql',
               nchars=1e6)
cat(sql)
result = query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing = billing_project)
```
