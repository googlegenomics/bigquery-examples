...
```{r af, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA, cache=FALSE}
...
```{r afeth, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA, cache=FALSE}
...
```{r sql maf, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA, cache=FALSE}
...
```{r sql maf no X, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA, cache=FALSE}
