...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/chrom-pos-ref-dups.sql",
               nchars=1e6)
cat(sql)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/count-chrom-pos-ref.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/three-chrom-pos-ref-dups.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/count-by-var-type-chrom-pos-ref-dups.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/count-by-var-type-chrom-pos-ref-singles.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/sample-chrom-pos-ref-dups.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment=NA}
sql <- readChar("../../sql/understanding-alternate-alleles/sample-likelihood.sql",
               nchars=1e6)
cat(sql)
result <- query_exec(project="google.com:biggene", dataset="1000genomes", query=sql, billing=billing_project)
```
