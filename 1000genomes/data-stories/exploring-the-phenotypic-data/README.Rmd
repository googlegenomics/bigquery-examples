...
sql <- readChar('../../sql/phenotype_sql/num-samples.sql',
               nchars=1e6)
cat(sql)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
sql <- readChar('../../sql/phenotype_sql/gender-ratio.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
sql <- readChar('../../sql/phenotype_sql/ethnicity-ratio.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
sql <- readChar('../../sql/phenotype_sql/ethnicity-by-superpop-ratio.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
sql <- readChar('../../sql/phenotype_sql/ethnicity-by-gender-ratio.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, comment=NA}
sql <- readChar('../../sql/phenotype_sql/family-sizes.sql',
               nchars=1e6)
cat(sql)
result <- query_exec(project='google.com:biggene', dataset='1000genomes', query=sql, billing=billing_project)
```
