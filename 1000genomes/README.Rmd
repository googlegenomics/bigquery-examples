...
* [Schema](https://bigquery.cloud.google.com/table/coherent-fx-462:1000_genomes.variants?pli=1)
...
```{r echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
# TODO fixme when these columns are back
result <- DisplayAndDispatchQuery("./sql/ratio-of-dbsnp-variants-by-chromosome.sql")
```

We see the tabular results:
```{r echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE, comment=NA, results="asis"}
# TODO fixme when these columns are back
